...
* `https://你的Worker名字.workers.dev/BWG` (备注：BWG 固定)
...
> **💡 提示：** > 本文首发于我的个人博客 **[Velo.x 的极客空间](https://222382.xyz)**。我在那里存放了更完整的 **[配置 Fail2Ban 防止 SSH 暴力破解教程](https://222382.xyz/posts/setup-fail2ban-for-ssh/)**，排版更精美，更新也更及时，欢迎来踩踩！🚀
